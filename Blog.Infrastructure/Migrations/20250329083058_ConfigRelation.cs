        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviewImageLink = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comment_Comment_RelatedCommentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavoriteArticle", x => new { x.FavoriteArticlesId, x.FavoritedById });
                    table.ForeignKey(
                        name: "FK_UserFavoriteArticle_Article_FavoriteArticlesId",
                        column: x => x.FavoriteArticlesId,
                        principalTable: "Article",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavoriteArticle_User_FavoritedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comment_RelatedCommentId",
                table: "Comment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFavoriteArticle_FavoritedById",
